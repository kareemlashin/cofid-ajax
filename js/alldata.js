    ...
    let myRquest2 = new XMLHttpRequest();
        ...
        function showData() {
            ...
            for (let i = 0; i < myData2.length; i++) {
                ...
                <td class="">	${ myData2[i].countryRegion}  </td>
                <td class="">  ${ myData2[i].combinedKey} </td>

                <td class="text-center">${ myData2[i].confirmed}</td>
                <td class="text-center"> ${ myData2[i].recovered} </td>
                <td class="text-center">${ myData2[i].deaths} </td>
                <td class="text-center">${ myData2[i].active} </td>
